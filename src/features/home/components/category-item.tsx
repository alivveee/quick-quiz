...
const CategoryItem = ({ id, title }: { id: number; title: string }) => {
  ...
  return (
    <Link
      ...
      className="group flex flex-col gap-3 items-center justify-center p-4 sm:p-6 h-32 sm:h-36 bg-white border border-border hover:border-primary hover:shadow-lg hover:shadow-primary/10 transition-all duration-300 rounded-xl"
    >
      <div className="relative">
        ...
        {IconComponent && (
          <IconComponent
            ...
            className="relative text-primary group-hover:scale-110 transition-all duration-300"
          />
        )}
      </div>
